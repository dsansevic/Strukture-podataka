...
int main()
{
	...
	printf("Unesite prezime iza kojeg ide\n");
	scanf(" %s", prez);
	UnosIza(Head, prez);
	IspisListe(Head->Next);

	printf("Unesite prezime za ispred\n");
	scanf(" %s", prez);
	UnosIspred(Head->Next, prez);
	IspisListe(Head->Next);*/
	...
	printf("\nZelite li pronaci odredenog korisnika?\nAko zelite, upisite 1.\n");
	scanf("%d", &a);
	if (a == 1)
	{
